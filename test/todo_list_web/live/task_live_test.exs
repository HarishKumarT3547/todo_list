defmodule TodoListWeb.TaskLiveTest do
  ...
  @create_attrs %{description: "some description", title: "some title", due_date: "2025-04-15", completed: true}
  @update_attrs %{description: "some updated description", title: "some updated title", due_date: "2025-04-16", completed: false}
  @invalid_attrs %{description: nil, title: nil, due_date: nil, completed: false}
